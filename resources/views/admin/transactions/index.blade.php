                    ...
                    <table id="customers" class="table table-bordered table-striped text-nowrap">
                        ...
                        @foreach($transactions as $key => $transaction)
                            <tr data-entry-id="{{ $transaction->id }}">
                                ...
                                <td><span class="badge badge-{{$transaction->checked_at!=null?'info':'warning'}}">{{$transaction->checked_at!=null?'checked':'unchecked'}}<br>{{$transaction->checked_at!=null?$transaction->updated_at->diffForHumans():''}}</span></td>
                                <td>
