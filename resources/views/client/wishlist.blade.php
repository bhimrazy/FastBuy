...
<!-- Mirrored from demo.hasthemes.com/fastbuy-preview/fastbuy/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2020 14:48:42 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Wishlist | Fastbuy - Mega Shop HTML Template</title>
                                    ...
                                    <div class="top-selector-wrapper">
                                        <ul class="single-top-selector">
                                            ...
                                            <li class="language list-inline-item">
                                                <span>Language:</span>
                                                <div class="btn-group">
                                                    <button class="dropdown-toggle"><img src="assets/images/menu/flag-icon/1.jpg" alt="">English<i class="fa fa-caret-down"></i></button>
                                                    <div class="dropdown-menu">
                                                        <ul>
                                                           <li><a href="#"><img src="assets/images/menu/flag-icon/1.jpg" alt=""> English</a></li>
                                        ...
                                        <li class="hm-minicart">
                                            ...
                                            <div class="minicart">
                                                <ul class="minicart-product-list">
                                                    <li>
                                                        <a href="product-details.html" class="minicart-product-image">
                                                            <img src="assets/images/minicart/1.jpg" alt="FB's Thumbnail">
                                                            <span class="product-quantity">1x</span>
                                                        </a>
                                                        <div class="minicart-product-details">
                                                            <h6><a href="product-details.html">Printed Dress</a></h6>
                                                            <span>$23.39</span>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <a href="product-details.html" class="minicart-product-image">
                                                            <img src="assets/images/minicart/2.jpg" alt="FB's Thumbnail">
                                                            <span class="product-quantity">1x</span>
                                                        </a>
                                                        <div class="minicart-product-details">
                                                            <h6><a href="product-details.html">Printed Chiffon Dress</a></h6>
                                                            <span>$16.40</span>
                                                        </div>
                                                        <button class="close" title="Remove">
                                                            <i class="fa fa-close"></i>
                                                ...
                                                <div class="minicart-button text-center">
                                                    <a href="checkout.html" class="fb-btn">
                                                        <span>Checkout</span>
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-5 col-sm-6">
                                ...
                                <div class="category-menu category-menu-hidden">
                                    ...
                                    <div id="cate-toggle" class="category-menu-list">
                                        <ul>
                                            <li class="right-menu"><a href="shop-left-sidebar.html"><span><img src="assets/images/category-thumb/1.jpg" alt="Category-thumb"></span>Electronics</a>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="fb-product-thumbnail"><a href="#"><img src="assets/images/product-thumb/1.png" alt=""></a></td>
                                            ...
                                            <tr>
                                                <td class="fb-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                <td class="fb-product-thumbnail"><a href="#"><img src="assets/images/product-thumb/2.png" alt=""></a></td>
                                            ...
                                            <tr>
                                                <td class="fb-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                <td class="fb-product-thumbnail"><a href="#"><img src="assets/images/product-thumb/3.png" alt=""></a></td>
                                            ...
                                            <tr>
                                                <td class="fb-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                <td class="fb-product-thumbnail"><a href="#"><img src="assets/images/product-thumb/4.png" alt=""></a></td>
                                                <td class="fb-product-name"><a href="#">Nero Urban Shoes</a></td>
                                                <td class="fb-product-price"><span class="amount">$40.19</span></td>
                                            ...
                                            <tr>
                                                <td class="fb-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                <td class="fb-product-thumbnail"><a href="#"><img src="assets/images/product-thumb/5.png" alt=""></a></td>
                                                <td class="fb-product-name"><a href="#">Nero Urban Shoes</a></td>
                                                <td class="fb-product-price"><span class="amount">$40.19</span></td>
                                                <td class="fb-product-stock-status"><span class="in-stock">out stock</span></td>
                                                <td class="fb-product-add-cart"><a href="#">add to cart</a></td>
                                            ...
                                            <tr>
                                                <td class="fb-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                <td class="fb-product-thumbnail"><a href="#"><img src="assets/images/product-thumb/6.png" alt=""></a></td>
                                                <td class="fb-product-name"><a href="#">Nero Urban Shoes</a></td>
                                                <td class="fb-product-price"><span class="amount">$40.19</span></td>
                                                <td class="fb-product-stock-status"><span class="out-stock">out stock</span></td>
                                                <td class="fb-product-add-cart"><a href="#">add to cart</a></td>
...
<!-- Mirrored from demo.hasthemes.com/fastbuy-preview/fastbuy/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2020 14:48:45 GMT -->
</html>
