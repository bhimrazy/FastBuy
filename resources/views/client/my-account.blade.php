...
<!-- Mirrored from demo.hasthemes.com/fastbuy-preview/fastbuy/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2020 14:47:30 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>My Account | Fastbuy - Mega Shop HTML Template</title>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <ul class="nav myaccount-tab-trigger" id="account-page-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="account-logout-tab" href="login-register.html"
